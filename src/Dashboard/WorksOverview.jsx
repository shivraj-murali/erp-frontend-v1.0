...
const WorksOverview = () => {
  ...
  return (
    <div className="  rounded-lg mx-auto my-0 h-full justify-center align-middle">
      <h2
        style={{ fontSize: "2rem" }}
        className="font-semibold mb-6 text-center mt-[6rem]"
      >
        Works Overview
      </h2>
      <div className="mt-[4rem]">
        <div
          ...
          className=" grid pr-0 justify-between my-auto"
        >
          <Link to="/project">
          ...
          <Link to="/project">
            <div className="max-w-sm p-6  border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex-initial mx-3">
              <svg
                ...
                viewBox="0 0 24 24"
                fill="red"
                className="w-16 h-16 mx-auto my-0 flex text-red"
              >
                <path d="M5.566 4.657A4.505 4.505 0 016.75 4.5h10.5c.41 0 .806.055 1.183.157A3 3 0 0015.75 3h-7.5a3 3 0 00-2.684 1.657zM2.25 12a3 3 0 013-3h13.5a3 3 0 013 3v6a3 3 0 01-3 3H5.25a3 3 0 01-3-3v-6zM5.25 7.5c-.41 0-.806.055-1.184.157A3 3 0 016.75 6h10.5a3 3 0 012.683 1.657A4.505 4.505 0 0018.75 7.5H5.25z" />
              </svg>
              <a href="#">
                <h3 className="text-xl font-semibold tracking-tight text-gray-900 mb-2 text-center text-red">
                  Pending Tasks
                </h3>
              </a>
              <p className="text-white text-5xl text-center mb-3 font-normal text-gray-500">
                <CountUp end={totalTask - task} />
              </p>
            </div>
          </Link>
          {/* Temp Div */}
          ...
          <Link to="/project">
            <div className="max-w-sm p-6   border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex-initial mx-3">
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-16 h-16 mx-auto my-0 flex text-green"
              >
                <path
                  strokeLinecap="round"
              ...
              <a href="#">
                <h3 className="text-xl font-semibold tracking-tight text-gray-900 mb-2 text-center text-green">
                  Completed
                </h3>
              </a>
              <p className="text-white text-5xl text-center mb-3 font-normal text-gray-500">
